...
La \hyperref[tab:tabla3]{Tabla 3} presenta el impacto de la disponibilidad de ChatGPT en el desarrollo de software respecto a cada lenguaje de programación. Para el lenguaje C, la disponibilidad de ChatGPT produjo un incremento significativo de 2,689 \textit{unique pushers} (error estándar de 0,439) según la estimación DiD, con aumentos adicionales observados en CS y SDiD (2,005 y 1,276 \textit{unique pushers}, respectivamente), ambos estadísticamente significativos. En C\#, la estimación DiD muestra un incremento significativo de 1,499 \textit{unique pushers} (error estándar de 0,456), con un efecto también significativo en CS (1,255); sin embargo, el estimador SDiD no alcanza significancia estadística (0,443). Para C++, se reporta un aumento de 2,210 \textit{unique pushers} según la estimación DiD (error estándar de 0,409), con incrementos significativos también en CS y SDiD (2,002 y 1,131 \textit{unique pushers}, respectivamente). En Go, la disponibilidad de ChatGPT resultó en un aumento de 1,411 \textit{unique pushers} (error estándar de 0,253) según DiD, con incrementos significativos en CS y SDiD (1,081 y 0,720 \textit{unique pushers}). En Java, se registra un incremento de 2,810 \textit{unique pushers} (error estándar de 0,886) según DiD, con aumentos en CS y SDiD (2,597 y 1,725 \textit{unique pushers}), siendo los tres estimadores estadísticamente significativos. Para JavaScript, se evidencia el mayor impacto con un aumento de 13,635 \textit{unique pushers} (error estándar de 2,989) según DiD, con incrementos en CS y SDiD (10,737 y 8,303 \textit{unique pushers}), todos significativos. En PHP, se observa un aumento de 0,904 \textit{unique pushers} (error estándar de 0,390) según DiD, con incrementos en CS y SDiD (0,907 y 0,916 \textit{unique pushers}), todos con significancia estadística al 5\%. Python muestra el segundo mayor impacto con un incremento de 7,688 \textit{unique pushers} (error estándar de 1,130) según DiD, con aumentos en CS y SDiD (6,156 y 4,525 \textit{unique pushers}), todos significativos al 1\%. En Ruby, la estimación DiD no alcanza significancia estadística (0,262; error estándar de 0,243), mientras que CS y SDiD muestran incrementos significativos de 0,662 y 0,808 \textit{unique pushers}, respectivamente. Finalmente, en TypeScript, se registra un incremento significativo de 7,181 \textit{unique pushers} (error estándar de 0,750) según DiD, con aumentos en CS y SDiD (3,673 y 3,078 \textit{unique pushers}), ambos estadísticamente significativos.
