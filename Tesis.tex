...
Existen versiones de ChatGPT que se han ido lanzando, de las cuales cada una es considerada como una LLM con ciertas variaciones con relación a la precisión, reconocimiento y velocidad de respuesta (OpenAI, 2024). En adición, las versiones más recientes han comenzado a añadir nuevas funcionalidades para abarcar más áreas como agentes especializados y, esencialmente, han emprendido la mejora de la ciberseguridad. A continuación, se exponen las tres versiones más recientes siguientes:


\begin{itemize}
  \item \textbf{Versión GPT-3.5:} Este modelo fue lanzado en noviembre de 2022 por OpenAI y posee las capacidades de comprensión y generación de lenguaje humano y código en un nivel avanzado. Resalta por el uso de APIs Chat Completions como herramienta para lograr la optimización del modelo; sin embargo, también se destaca su uso para tareas que no requiere expresamente de interacción escrita. Esta versión se ha mantenido de forma gratuita en su sitio web permitiendo alcanzar una cobertura casi en todo el mundo. Por ello, no es casual que la mayor parte de estudios disponibles la incluyan.

  \item \textbf{Versión GPT-4.0:} Este modelo multimodal avanzado fue lanzado en marzo de 2023 con acceso limitado mediante una suscripción de pago y posee algunas mejoras frente al modelo GPT-3.5. Así, GPT-4.0 brinda una generación de texto partiendo de contenido multimedia y una mayor precisión para resolver problemas de mayor complejidad por su mayor amplitud de conocimiento y habilidades de razonamiento avanzado. Asimismo, hay dos de sus características novedosas que resaltan: la mayor capacidad de la memoria para interactuar desde la interfaz con el usuario y la implementación de la herramienta Code Interpreter, capaz de ofrecer una respuesta de calidad, sugerencias y propuestas de código para mejorar los proyectos del usuario.

  \item \textbf{Versión GPT-4o\footnote{En vista del período temporal abarcado en el estudio, no será considerado en la estimación.}:} Este modelo multimodal fue lanzado en mayo de 2024 (también conocido como \textit{Omni} por su terminación en la letra ``o'') y adquiere el nivel de razonamiento del modelo GPT-4.0, así como las bondades de la generación de respuestas desde archivos multimedia. Esta versión incorpora como habilidades diferenciales a su mayor eficiencia, generando textos 2 veces más rápidos que GPT-4.0 a un costo de acceso inferior y su mayor visión y rendimiento en traducción de múltiples idiomas.
\end{itemize}
