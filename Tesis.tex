...
\begin{minipage}{\linewidth}
\smallskip\small\textit{Nota.} Estadísticos descriptivos calculados a partir de la base de datos GitHub Innovation Graph (tabla \textit{languages}), que registra el número de \textit{unique pushers} por cada 100\,000 habitantes, desagregado por país, lenguaje de programación y trimestre. El periodo de pretratamiento comprende Q1-2020 a Q3-2022 (12 trimestres) y el de postratamiento Q4-2022 a Q4-2023 (4 trimestres). El grupo de tratamiento incluye los 133 países con acceso a ChatGPT al momento de su lanzamiento en noviembre de 2022. Fuente: GitHub Innovation Graph (\url{https://github.com/github/innovationgraph}). Elaboración propia.
\end{minipage}
\end{table}
...
Las variables de control empleadas en la estimación con controles (Cuadro 5) fueron extraídas del \textbf{Banco Mundial} y corresponden a dos indicadores de infraestructura digital:
