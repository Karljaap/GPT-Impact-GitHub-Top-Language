...
\end{exampleblock}
\centering\footnotesize El coeficiente de tratamiento es \textbf{multiplicativo} en \textbf{exposición} ($\theta_c$, por lenguaje) y \textbf{absorción} ($\phi_i$, por país): el efecto se concentra donde \emph{coinciden} ambas ---la esencia de la adopción \textit{heterogénea}--- y sustenta la \textbf{H2}. \textit{Derivación completa de 8 pasos en el Apéndice~B.}
\end{frame}
